...
var marqueeContent2 = document.querySelector(".marquee-cont2");

function marqqueFnc2() {
    if (marqueeContent2) {
        var root = document.documentElement;
        var marqueeElementsDisplayed = getComputedStyle(root).getPropertyValue("--marquee-elements-displayed2");
...
var marqueeContent3 = document.querySelector(".marquee-cont3");

function marqqueFnc3() {
    if (marqueeContent3) {
        var root = document.documentElement;
        var marqueeElementsDisplayed = getComputedStyle(root).getPropertyValue("--marquee-elements-displayed3");
...
function ifHaveShips() {
    if (document.querySelector('.page-section')) {
        ...
        const menuItems = document.querySelectorAll(".left-control-menu li a");
...
let productsDopSlider = [...document.querySelectorAll('.comments-list')];
